...
resume_pdf_link = 'https://drive.google.com/file/d/10z8BW4k8InNuruCHDtWY6XFCok8gPzQn/view?usp=sharing'


@app.route('/')
def index():
    age = int((datetime.date.today() - datetime.date(2002, 6, 12)).days / 365)
